...
const schema = new Schema({
  ...
  companyWebsite: String, businessMail: { type: String, default: null }, mailPassword: { type: String, default: null, select: false }, port: { type: Number, default: null }, mailServer: { type: String, default: null },
